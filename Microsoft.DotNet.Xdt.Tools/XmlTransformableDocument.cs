...
namespace Microsoft.DotNet.Xdt.Tools
{
    public class XmlTransformableDocument : XmlFileInfoDocument, IXmlOriginalDocumentService
    {
        ...
        private void CloneOriginalDocument() => _xmlOriginal = (XmlDocument)CloneNode(true);
        ...
        private static bool IsXmlEqual(XmlDocument xmlOriginal, XmlDocument xmlTransformed) => false;
